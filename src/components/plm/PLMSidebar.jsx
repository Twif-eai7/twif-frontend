      ...
      >
        ...
        `}>
          <button
            ...
            className="border-none bg-none cursor-pointer text-[#1A1A18] p-0.5 flex items-center flex-shrink-0 hover:opacity-60 transition-opacity"
          >
            <ToggleIcon />
          </button>
        </div>

        <CategoryNav skus={skus} />
      </aside>
