...
export default function MisBuyerWise({ year, months, rows, openRows, buyerRateMap, commissionMap, rateMap, plMode, showInr, inrRate }) {
    ...
    <div>
      ...
      {mappingError && (
        <div className="mb-3 px-4 py-2.5 rounded-lg border border-red-200 bg-red-50 text-red-600 text-xs">
          Couldn&apos;t load buyer→handler mapping: {mappingError}
        </div>
      )}
      {!hasAnyData ? (
